...
followed by default do files with shorter and shorter prefixes of the extension, finally
ending in `default.do`. For example, the target `file.a.b.c.d.e` results in a search for
the following do scripts:

  file.a.b.c.d.e.do
  default.a.b.c.d.e.do
  default.a.b.c.d.do
  default.a.b.c.do
  default.a.b.do
  default.a.do
...
Jumping ahead slightly, note that in the case of multiple extensions, the $2 argument to the do script contains
all but one extension. In the example above, $2 would be `file.a.b.c.d`.
